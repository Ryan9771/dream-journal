...
const styles = {
  ctn: ["gap-5", "pt-2.5", "flex", "flex-col", "px-4", "lg:gap-8"],
  heading: ["text-lg", "text-peach", "lg:text-center", "lg:text-xl"],
  selectorCtn: [
    "flex",
    "w-full",
    "items-center",
